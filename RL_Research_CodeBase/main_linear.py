...
'''Main file for the linear energy harvesting model'''

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

#####################  hyper parameters  ####################
## Pn = 0.5, 0.676, 0.84, 1, 1.2
Pn = 1.2  # Transmit power of PD
K=2
...
location_vector = np.array([[0,1],[0,1000]]) #locations of GB users K=2 primary users
